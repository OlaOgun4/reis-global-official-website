    ...
    <main className="reis-site min-h-screen overflow-x-hidden">
      <header className="reis-header fixed inset-x-0 top-0 z-50 border-b backdrop-blur-xl">
        <div className="mx-auto flex h-20 max-w-[1440px] items-center justify-between px-6 lg:px-10">
          ...
          <a href="#enquiry" className="reis-primary-button hidden items-center gap-2 rounded-lg px-5 py-3 text-sm font-semibold lg:inline-flex">
        ...
        <div className="relative mx-auto grid min-h-[660px] max-w-[1440px] items-center gap-12 px-6 py-20 lg:grid-cols-[0.9fr_1.1fr] lg:px-10">
          ...
          <div className="reis-panel rounded-[2rem] border p-7 sm:p-9">
            <div className="grid gap-5 sm:grid-cols-2">
              <ContactTile icon={Mail} title="Email" text="hello@reis-global.com" href="mailto:hello@reis-global.com" />
            ...
            {submitted ? (
              <div className="flex min-h-[420px] flex-col items-center justify-center text-center">
                ...
                <p className="mt-3 max-w-md leading-7 opacity-65">
                  The Version 1.0 form is currently a front-end demonstration. Please email your enquiry to hello@reis-global.com while the production mail service is being configured.
                </p>
                <a href="mailto:hello@reis-global.com" className="reis-primary-button mt-7 inline-flex items-center gap-2 rounded-lg px-6 py-3 font-semibold">
      ...
      <section className="reis-cta-section px-6 py-24 lg:px-10">
        <div className="mx-auto flex max-w-5xl flex-col items-center text-center">
          ...
          <a href="mailto:hello@reis-global.com" className="reis-primary-button mt-9 inline-flex items-center gap-2 rounded-lg px-7 py-4 font-semibold">Contact REIS Global <ArrowRight size={18} /></a>
        </div>
      </section>
        ...
        <div className="mx-auto grid max-w-[1440px] gap-10 px-6 py-14 md:grid-cols-2 lg:grid-cols-4 lg:px-10">
          ...
          <div>
            ...
            <div className="mt-4 flex flex-col gap-3 text-sm opacity-60">
              <a href="/about">About</a><a href="/capabilities">Capabilities</a><a href="/solutions">Solutions</a><a href="/research">Research</a><a href="/publications">Publications</a>
            </div>
          </div>
          <div>
            <h3 className="font-semibold">Contact</h3>
            <div className="mt-4 flex flex-col gap-3 text-sm opacity-60"><a href="mailto:hello@reis-global.com">hello@reis-global.com</a><span>United Kingdom</span><span>Serving clients globally</span></div>
          </div>
        </div>
