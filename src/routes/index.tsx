...
const solutions = [
  ...
  [Landmark, "Governance Transformation", "Embedding policy, compliance, risk and accountability into digital transformation.", "governance-transformation"],
] as const;
