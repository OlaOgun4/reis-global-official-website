...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "REIS Global | Research, Engineering, Innovation, Solutions & Governance" },
      ...
      { property: "og:description", content: "Research-led engineering, secure digital solutions and governance for complex transformation." },
      ...
      <section id="top" className="reis-hero relative isolate overflow-hidden pt-20">
        ...
        <div className="relative mx-auto grid min-h-[760px] max-w-[1440px] items-center gap-8 px-6 py-20 lg:grid-cols-[0.86fr_1.14fr] lg:px-10">
          <div className="z-10 max-w-2xl">
            <p className="reis-eyebrow text-xs font-bold uppercase tracking-[0.28em] sm:text-sm">Research · Engineering · Innovation · Solutions · Governance</p>
