...
const solutions = [
  [Users, "GovVisit", "Secure visitor management for government and enterprise facilities."],
  [Leaf, "Farm Naturale", "An agri-platform connecting learning, markets, finance and support."],
  [Scale, "Justice Transformation", "Digital solutions improving justice delivery and citizen access."],
  [ShieldCheck, "National Security Platforms", "Intelligence and response systems strengthening readiness."],
  [Leaf, "Digital Agriculture", "Technology-driven systems improving productivity and food security."],
  [Landmark, "Government Digital Platforms", "End-to-end public-service platforms built for transformation."],
] as const;
